...
`;
 ...
 smd({
   pattern: "tgs",
   desc: "Télécharge les stickers Telegram.",
   category: "downloader",
   filename: __filename,
   use: "<ajoutez l'URL du sticker.>"
}, async (_0x19df48, _0x155c01) => {
   const TOKEN = '7255525909:AAHrp1dDCKbOSoiljFcF1fl4PQ9Tm2-E1Xo'; // Votre token Telegram ajouté ici
   try {
     if (!_0x155c01) {
       return await _0x19df48.reply("_Entrez une URL de sticker tg_\nExemple : .tgs https://t.me/addstickers/Oldboyfinal\nGardez à l'esprit qu'il y a un risque de ban si utilisé fréquemment.");
     }
     
     if (!_0x155c01.includes("addstickers")) {
       return await _0x19df48.reply("_Entrez une URL valide de sticker tg_\nExemple : .tgs https://t.me/addstickers/Oldboyfinal");
     }
     
     let _0x2a4fb1 = _0x155c01.split("|")[0];
     let _0x27aa70 = _0x2a4fb1.split("/addstickers/")[1];
     
     let { result: _0x4a601d } = await fetchJson(`https://api.telegram.org/bot${TOKEN}/getStickerSet?name=${encodeURIComponent(_0x27aa70)}`);
     let _0x54b45a = _0x155c01.split("|")[1] || "";
     let _0x56bec3 = `Total stickers: ${_0x4a601d.stickers.length}\n*Temps estimé pour la fin:* ${_0x4a601d.stickers.length * 1.5} secondes\nGardez à l'esprit qu'il y a un risque de ban si utilisé fréquemment.`;

     if (_0x4a601d.is_animated) {
       return await _0x19df48.reply("Les stickers animés ne sont pas supportés.");
     ...
     await _0x19df48.reply(`${_0x56bec3}\n\n_Téléchargement en tant que ${_0x4cca92} De l'index *${_0x33784b}* à *${_0x26c3a3}*._\nSi vous voulez en télécharger plus, utilisez comme suit :\n\n.tgs ${_0x2a4fb1} |  10 ,  20 ; photo`);
     
     for (_0x33784b; _0x33784b < _0x26c3a3; _0x33784b++) {
       let _0x4de16f = await fetchJson(`https://api.telegram.org/bot${TOKEN}/getFile?file_id=${_0x4a601d.stickers[_0x33784b].file_id}`);
       let _0x3c2608 = `https://api.telegram.org/file/bot${TOKEN}/${_0x4de16f.result.file_path}`;
       ...
       if (_0x3a6ece) {
         ...
         await _0x19df48.bot.sendMessage(_0x19df48.chat, {
           image: { url: _0x3c2608 },
           caption: `*Sticker Telegram à l'index ${_0x33784b + 1} téléchargé*`
         });
       }
     }
   } catch (error) {
     await _0x19df48.error(error + "\n\nCommande : tgs", error, "*Erreur lors de l'envoi des stickers Telegram !!!*");
   }
});
 ...
 smd({
   ...
   category: "downloader",
   filename: __filename,
   use: "<Hii,this is JINHUYK-MD>"
 }, async (_0x55aba2, _0x56da6b) => {
   try {
     let _0x204f81 = _0x55aba2.reply_text ? _0x55aba2.reply_text : _0x56da6b;
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am JINHUYK-MD whatsapp bot._*");
     }
     try {
 ...
 smd({
   ...
   try {
     ...
     var _0x28302f = {
       ...(await _0x54463e.bot.contextInfo(Config.botname, "ê±á´É´É¢ á´á´á´¡É´Êá´á´á´á´Ê"))
     };
     if (_0x37323e) {
 ...
 smd({
   ...
   try {
     ...
     if (_0x19c223.toString() == "NaN" || _0x19c223 < 1 || _0x19c223 > 160) {
       return _0x2ee3dd.reply("*_â Give a number between 1 to 160_*");
     }
     ...
     var _0x29fdd9 = {
       ...(await _0x2ee3dd.bot.contextInfo(Config.botname, "á´Éªá´á´á´á´ ê±á´á´É´á´ " + _0x19c223))
     };
     let _0x4737bb = {
       audio: _0x2ba501,
       fileName: "JINHUYK-MD tiktok Sound" + _0x19c223 + ".m4a",
       mimetype: "audio/mpeg",
       ptt: true,
 ...
 smd({
   ...
   try {
     ...
     var _0x2e165b = {
       ...(await _0x1da3da.bot.contextInfo(Config.botname, "ÊÉªÉ´É¢á´á´É´á´ á´á´á´¡É´Êá´á´á´á´Ê"))
     };
     let _0x5c9751 = {
       audio: {
 ...
 smd(
   ...
   async (m, query) => {
     try {
       ...
       const contextInfo = {
         ...(await m.bot.contextInfo(Config.botname, "á´ÉªÉ´á´á´Êá´ê±á´ á´á´á´¡É´Êá´á´á´á´Ê")),
       };
 ...
 smd(
   ...
   async (m, url) => {
     try {
       ...
       const caption = `ã *JINHUYK-MD MEDIAFIRE DOWNLOADER* ã\n\n *Name* : ${result.name}\n *Size* : ${result.size}\n *Mime* : ${result.mime}\n\n\n${Config.caption}`;
 ...
 smd({
   ...
   try {
     ...
     var _0x3b1bff = {
       ...(await _0x1d4717.bot.contextInfo(Config.botname, "Êá´á´Ê á´ Éªá´á´á´"))
     };
     let _0x4d676e = {
     ...
     try {
       ...
       var _0x3b1bff = {
         ...(await _0x1d4717.bot.contextInfo(Config.botname, "Êá´á´á´á´Êá´ á´ Éªá´á´á´"))
       };
 ...
 smd({
   ...
   try {
     ...
     var _0x29af08 = {
       ...(await _0x3f8930.bot.contextInfo(Config.botname, "Êá´á´á´á´Êá´ á´ Éªá´á´á´"))
     };
     let _0x4c646c = {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x5696a7 || !_0x1d542b[0]) {
       return await _0x17c662.reply("âPlease provide me a url");
     }
     ...
     var _0x10e2fa = {
       ...(await _0x17c662.bot.contextInfo(Config.botname, "Êá´á´á´á´ á´á´3 Êá´á´á´á´Êá´"))
     };
     let _0x300d1a = {
       document: {
         url: _0x59bbaa
       ...
       mimetype: "audio/mpeg",
       fileName: "JINHUYK-MD--" + _0x1d542b[1] + ".mp3",
       caption: Config.caption,
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     if (_0x5b8ee5[0].includes("JINHUYK-MD SONG DOWNLOADER")) {
     ...
     } else if (_0x5b8ee5[0].includes("JINHUYK-MD YOUTUBE DOWNLOADER")) {
     ...
     } else if (_0x5b8ee5[0].includes("JINHUYK-MD APK DOWNLOAD LIST")) {
 ...
 function _0xe8a3() {
   const _0x1872b6 = ["audio", "random", "length", ".mp4", "6710240SkWnCZ", "readFileSync", "Downloads video from playlist.", "<yt playlist url>", "title", "videos", "sendMessage", "2179701ijsDnM", "botname", "4565025fjxWjZ", "pushName", "168uBIxwJ", "document", "includes", "216vVeWdZ", "itag", "\n â¿» File Size : ", "reply", "chat", "11410952QXDvWH", "mp3", " MB", "614495gBYQxj", "split", "toLowerCase", "floor", "downloader", "videoDetails", "audio/mpeg", "videoId", "This Process will take a bit time.", "2487090FcjOyi", "â File size bigger than ", "pipe", "statSync", "mb.", "test", "log", "lengthSeconds", "getInfo", "61665AJJjOP", "./temp/", "unlinkSync"];
   _0xe8a3 = function () {
     return _0x1872b6;
   };
   return _0xe8a3();
         ...
         try {
           ...
           if (_0x4a0671 <= _0x1a03f5) {
             let _0x3eab5e = {
               ...
               fileName: "" + _0x5ec28d,
               caption: _0x3ef119 == _0x5c8996(239) ? "" : " â¿» Title : " + _0x5ec28d + _0x5c8996(243) + _0x4a0671 + _0x5c8996(248),
               headerType: 4,
               contextInfo: {
                 externalAdReply: {
